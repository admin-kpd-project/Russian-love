              ...
              availableFriends.map((friend) => {
                ...
                return (
                  <Pressable
                    ...
                    style={[styles.friend, sel && styles.friendOn]}
                  >
                    ...
                    {sel ? <Check size={22} color="#ef4444" /> : null}
                  </Pressable>
                );
              })
            )}
...
const styles = StyleSheet.create({
  ...
  head: { padding: 22, paddingTop: 48 },
  x: { position: "absolute", top: 14, right: 14, padding: 8, borderRadius: 999, backgroundColor: "rgba(255,255,255,0.2)" },
  icoBg: { width: 52, height: 52, borderRadius: 16, backgroundColor: "rgba(255,255,255,0.2)", alignItems: "center", justifyContent: "center", marginBottom: 10 },
  headT: { fontSize: 22, fontWeight: "800", color: "#fff" },
  headS: { fontSize: 14, color: "rgba(255,255,255,0.88)" },
  body: { padding: 18 },
  ...
  friend: { flexDirection: "row", alignItems: "center", gap: 12, padding: 12, borderRadius: 14, backgroundColor: "#fafaf9", marginBottom: 8, borderWidth: 2, borderColor: "transparent" },
  friendOn: { backgroundColor: "#fff7ed", borderColor: "#ef4444" },
